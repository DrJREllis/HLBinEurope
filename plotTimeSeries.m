function [] = plotTimeSeries(k,citMat,spyr,nYrs,rsdArray,comArray,ocean,Ersd,Ecom,Crsd,Ccom,Irsd,Icom,Rrsd,Rcom,figname)
...
figname=append(figname,'_',num2str(k))
    ...
    print(1,'-dpdf',append('Figures/SingleSims/',figname,'_TimeSeries.pdf'));
    print(1,'-dtiff',append('Figures/SingleSims/',figname,'_TimeSeries.tiff'));
    print(1,'-deps',append('Figures/SingleSims/',figname,'_TimeSeries.eps'));
    savefig(append('Figures/SingleSims/',figname,'_TimeSeries.fig'));
